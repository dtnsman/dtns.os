...
async function pay (req, res) {
    ...
    // 配置回调接口
    // formData.addField('notifyUrl', 'http://static.dtns.dtns.top')
    formData.addField('notifyUrl', typeof g_system_alipay_sdk_notify_url !='undefined' ? g_system_alipay_sdk_notify_url: 'http://static.dtns.dtns.top/forklist/notify'); // 当支付完成后，支付宝主动向我们的服务器发送回调的地址
    // formData.addField('returnUrl', 'http://static.dtns.dtns.top/return'); // 当支付完成后，当前页面跳转的地址
...
async function testpay () {
    ...
    // 配置回调接口
    // formData.addField('notifyUrl', 'http://static.dtns.dtns.top')
    formData.addField('notifyUrl', typeof g_system_alipay_sdk_notify_url !='undefined' ? g_system_alipay_sdk_notify_url: 'http://static.dtns.dtns.top/notify'); // 当支付完成后，支付宝主动向我们的服务器发送回调的地址
    // formData.addField('returnUrl', 'http://static.dtns.dtns.top/return'); // 当支付完成后，当前页面跳转的地址
...
async function h5_pay (req, res) {
  ...
  formData.addField('notifyUrl',  typeof g_system_alipay_sdk_h5_notify_url !='undefined' ? g_system_alipay_sdk_h5_notify_url: 'http://static.dtns.dtns.top/forklist/h5_notify'); // 当支付完成后，支付宝主动向我们的服务器发送回调的地址
