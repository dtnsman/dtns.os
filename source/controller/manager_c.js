...
module.exports.isManagerUid =isManagerUid;
function isManagerUid(user_id) {
    if(!user_id) return false;
    return user_id == 'user_29L7TgLavKkUSKMN' || user_id=='user_31RZzu8cvEaGbVtm' || user_id=='user_21DZzaUAHvVaSprg'
}
/**
 * 查询认证的申请纪录
 * @type {queryUserRoleOrders}
 */
module.exports.queryAllUserRoleOrders =queryAllUserRoleOrders;
 ...
 * @type {roleDeny}
 */
module.exports.roleDeny =roleDeny;
 ...
 * @type {queryRmbOrders}
 */
module.exports.queryRmbOrders =queryRmbOrders;
 ...
 * @type {queryRmbOrders}
 */
module.exports.queryGSBOrders =queryGSBOrders;
 ...
 * @type {querySysMsg}
 */
module.exports.querySysMsg =querySysMsg;
